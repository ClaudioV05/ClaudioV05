...
[![My Skills](https://skillicons.dev/icons?i=ai,java,spring,maven,git,github,githubactions,docker,kubernetes,terraform,elasticsearch,md,angular,js,ts,nodejs,postgres,figma,vscode,azure,aws,idea&perline=6&theme=light)](https://skillicons.dev)
