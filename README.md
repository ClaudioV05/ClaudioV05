...
[![My Skills](https://skillicons.dev/icons?i=java,spring,maven,angular,git,github,md,html,css,sass,js,ts,nodejs,postgres,oracle,docker,figma,vscode,azure,aws,terraform,idea&perline=6&theme=light)](https://skillicons.dev)
